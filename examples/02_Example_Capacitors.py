...
print(f'dss.capacitors_read_num_step(): {dss.capacitors_read_num_steps()}')
...
print(f'dss.capacitors_read_num_steps(): {dss.capacitors_read_num_steps()}')
print(f'dss.capacitors_available_steps(): {dss.capacitors_available_steps()}')
print(f'dss.capacitors_add_step(): {dss.capacitors_add_step()}')
print(f'dss.capacitors_read_num_steps(): {dss.capacitors_read_num_steps()}')
print(f'dss.capacitors_available_steps(): {dss.capacitors_available_steps()}')
print(f'dss.capacitors_subtract_step(): {dss.capacitors_subtract_step()}')
print(f'dss.capacitors_read_num_teps(): {dss.capacitors_read_num_steps()}')
print(f'dss.capacitors_subtract_step(): {dss.capacitors_subtract_step()}')
print(f'dss.capacitors_available_steps(): {dss.capacitors_available_steps()}')
