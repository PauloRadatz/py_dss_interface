...
If you want to use your OpenDSS, you should pass an argument to the
DSSDLL class which is the path to the DLL folder, as shown below:

.. code:: ipython3

    dll_path = r"C:\PauloRadatz\GitLab\opendsspy_workflow\DDLL"

The folder DDLL should have both version of the OpenDSS direct dll,
placed in the folders as shown below:
...
DSSView.exe allows the tool to plot OpenDSS results such as Circuit and
monitors plots.
