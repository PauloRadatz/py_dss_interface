...
class FusesI(Base):
    ...
    def switched_term_read(self) -> int:
    ...
    def switched_term_write(self, argument: int) -> int:
    ...
    def idx_write(self, argument: int) -> int:
