...
class ReclosersF(Base):
    ...
    def reclosers_read_phasetrip(self) -> float:
    ...
    def reclosers_write_phasetrip(self, argument) -> float:
    ...
    def reclosers_read_phaseins(self) -> float:
    ...
    def reclosers_write_phaseins(self, argument) -> float:
    ...
    def reclosers_read_groundtrip(self) -> float:
    ...
    def reclosers_write_groundtrip(self, argument) -> float:
    ...
    def reclosers_read_groundinst(self) -> float:
    ...
    def reclosers_write_groundinst(self, argument) -> float:
        argument = Base.check_float_param(argument)
