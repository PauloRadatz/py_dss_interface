...
class CktElementV(Base):
    ...
    def _bus_names(self) -> List[str]:
        ...
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 0)
    ...
    def _phase_losses(self) -> List[float]:
        ...
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 6)
    ...
    def _seq_voltages(self) -> List[float]:
        """Delivers an array of doubles with the symmetrical component voltages per phase at the terminals of the active
         circuit element."""
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 7)
    ...
    def _seq_currents(self) -> List[float]:
        """Delivers an array of doubles with the symmetrical component Currents per phase at the terminals of the active
         circuit element."""
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 8)
    ...
    def _seq_powers(self) -> List[float]:
        ...
        circuit element."""
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 9)
    ...
    def _property_names(self) -> List[str]:
        ...
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 10)
    ...
    def _residuals_currents(self) -> List[float]:
        ...
        circuit element."""
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 11)
    ...
    def _y_prim(self) -> List[float]:
        ...
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 12)
    ...
    def _cplx_seq_voltages(self) -> List[float]:
        ...
        element."""
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 13)
    ...
    def _cplx_seq_currents(self) -> List[float]:
        ...
        element."""
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 14)
    ...
    def _variables_names(self) -> List[str]:
        ...
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 15)
    ...
    def _variables_values(self) -> List[float]:
        ...
        element is a PCElement. Otherwise, null string."""
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 16)
    ...
    def _node_order(self) -> List[int]:
        ...
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 17)
    ...
    def _currents_mag_ang(self) -> List[float]:
        ...
        element. """
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 18)
    ...
    def _voltages_mag_ang(self) -> List[float]:
        ...
        element. """
        return Bridge.variant_pointer_read(self.dss_obj.CktElementV, 19)
