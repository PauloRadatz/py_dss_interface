...
class CapControlsF(Base):
    ...
    def vmax_write(self, argument: float) -> float:
    ...
    def vmin_write(self, argument: float) -> float:
    ...
    def delay_write(self, argument: float) -> float:
    ...
    def delay_off_write(self, argument: float) -> float:
    ...
    def dead_time_write(self, argument: float) -> float:
