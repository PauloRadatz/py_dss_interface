...
class RelaysI(Base):
    ...
    def relays_read_monitoredterm(self) -> int:
    ...
    def relays_write_monitoredterm(self, argument) -> int:
    ...
    def relays_read_switchedterm(self) -> int:
    ...
    def relays_write_switchedterm(self, argument) -> int:
