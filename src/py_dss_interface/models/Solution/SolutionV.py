...
class SolutionV(Base):
    ...
    def solution_event_log(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.SolutionV, ctypes.c_int(0), ctypes.c_int(0), None)
    ...
    def solution_nc_matrix(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.SolutionV, ctypes.c_int(1), ctypes.c_int(0), None)
    ...
    def solution_bus_levels(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.SolutionV, ctypes.c_int(2), ctypes.c_int(0), None)
    ...
    def solution_inc_matrix_rows(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.SolutionV, ctypes.c_int(3), ctypes.c_int(0), None)
    ...
    def solution_inc_matrix_cols(self):
        ...
        depending on the way the Branch to node incidence matrix was calculated (CalcIncMatrix/CalcIncMatrix_O)
        the result could be very different."""
        return Bridge.VarArrayFunction(self.dss_obj.SolutionV, ctypes.c_int(4), ctypes.c_int(0), None)
    ...
    def solution_laplacian(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.SolutionV, ctypes.c_int(5), ctypes.c_int(0), None)
