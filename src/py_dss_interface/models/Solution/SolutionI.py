...
class SolutionI(Base):
    ...
    def solution_read_maxiterations(self) -> int:
    ...
    def solution_write_maxiterations(self, argument) -> int:
    ...
    def solution_read_loadmodel(self) -> int:
    ...
    def solution_write_loadmodel(self, argument) -> int:
    ...
    def solution_read_addtype(self) -> int:
    ...
    def solution_write_addtype(self, argument) -> int:
    ...
    def solution_read_controlmode(self) -> int:
    ...
    def solution_write_controlmode(self, argument) -> int:
    ...
    def solution_read_controliterations(self) -> int:
    ...
    def solution_write_controliterations(self, argument) -> int:
    ...
    def solution_sampledocontrolactions(self) -> int:
    ...
    def solution_checkfaultstatus(self) -> int:
    ...
    def solution_solvedirect(self) -> int:
    ...
    def solution_solvepflow(self) -> int:
    ...
    def solution_solvenocontrol(self) -> int:
    ...
    def solution_solvepluscontrol(self) -> int:
    ...
    def solution_initsnap(self) -> int:
    ...
    def solution_checkcontrols(self) -> int:
    ...
    def solution_samplecontroldevices(self) -> int:
    ...
    def solution_docontrolactions(self) -> int:
    ...
    def solution_buildymatrix(self) -> int:
    ...
    def solution_systemychanged(self) -> int:
    ...
    def solution_totaliterations(self) -> int:
    ...
    def solution_mostiterationsdone(self) -> int:
    ...
    def solution_read_controlactionsdone(self) -> int:
    ...
    def solution_write_controlactionsdone(self, argument) -> int:
    ...
    def solution_finishtimestep(self) -> int:
    ...
    def solution_calcincmatrix(self) -> int:
    ...
    def solution_calcincmatrix_0(self) -> int:
