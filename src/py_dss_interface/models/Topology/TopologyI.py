...
class TopologyI(Base):
    ...
    def topology_numisolatedloadss(self) -> int:
    ...
    def topology_backwardbranch(self) -> int:
    ...
    def topology_firstload(self) -> int:
    ...
    def topology_nextload(self) -> int:
    ...
    def topology_activelevel(self) -> int:
