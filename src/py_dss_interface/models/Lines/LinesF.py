...
class LinesF(Base):
    ...
    def length_write(self, argument: float) -> float:
    ...
    def rg_write(self, argument: float) -> float:
    ...
    def xg_write(self, argument: float) -> float:
