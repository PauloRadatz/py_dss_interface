...
class SwtControlsS(Base):
    ...
    def _name_read(self):
        result = ctypes.c_char_p(self._dss_obj.SwtControlsS(ctypes.c_int32(0), "".encode('ascii')))
    ...
    def _switched_obj_read(self):
        result = ctypes.c_char_p(self._dss_obj.SwtControlsS(ctypes.c_int32(2), "".encode('ascii')))
        return result.value.decode('ascii')
