...
class PDElementsF(Base):
    ...
    def pdelements_read_faultrate(self) -> float:
    ...
    def pdelements_write_faultrate(self, argument) -> float:
    ...
    def pdelements_read_pctpermanent(self) -> float:
    ...
    def pdelements_write_pctpermanent(self, argument) -> float:
    ...
    def pdelements_accumulatedl(self) -> float:
    ...
    def pdelements_repairtime(self) -> float:
    ...
    def pdelements_totalmiles(self) -> float:
