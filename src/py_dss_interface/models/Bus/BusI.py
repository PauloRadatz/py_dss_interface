...
class BusI(Base):
    ...
    def bus_coord_defined(self) -> int:
        ...
        result = self.get_integer(2, 0)
        Base.check_assertion_result(result, "Bus coordinate not defined!", "Bus coordinates not finded!",
                                    expected_value=1)
        return result

    def bus_get_unique_node_number(self, start_number: int) -> int:
        ...
        return self.get_integer(3, start_number)
