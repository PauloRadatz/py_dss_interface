...
class BusF(Base):
    ...
    def write_x(self, param_coordinate) -> int:
    ...
    def write_y(self, param_coordinate: float) -> int:
    ...
    def write_latitude(self, latitude_param: float) -> float:
    ...
    def write_longitude(self, longitude_param: float) -> float:
