...
class BusV(Base):
    ...
    def bus_nodes(self) -> List[int]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 2, None, '')

    def bus_voc(self):
        """Returns the open circuit voltage as complex array."""
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 3, None, '')

    def bus_isc(self):
        """Returns the short circuit current as complex array."""
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 4, None, '')

    def bus_pu_voltages(self):
        """Returns the voltages in per unit at bus as complex array."""
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 5, None, '')

    def bus_zsc_matrix(self):
        """Returns the complex array of Zsc matrix at bus, column by column."""
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 6, None, '')

    def bus_zsc1(self):
        """Returns the complex array of Zsc matrix at bus, column by column."""
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 7, None, '')
    ...
    def bus_vll(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 11, None, '')
    ...
    def bus_line_list(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 15, None, '')
    ...
    def bus_all_pde_active_bus(self) -> List[str]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.BUSV, 19, None, '')
