...
class XYCurvesV(Base):
    ...
    def _x_array_read(self) -> List[float]:
        ...
        return Bridge.variant_pointer_read(self.dss_obj.XYCurvesV, 0)
    ...
    def _x_array_write(self, arg: List[float]) -> List[float]:
        ...
        if setting."""
        return Bridge.variant_pointer_write(self.dss_obj.XYCurvesV, 1, arg)
    ...
    def _y_array_read(self) -> List[float]:
        ...
        return Bridge.variant_pointer_read(self.dss_obj.XYCurvesV, 2)
    ...
    def _y_array_write(self, arg: List[float]) -> List[float]:
        ...
        if setting."""
        return Bridge.variant_pointer_write(self.dss_obj.XYCurvesV, 3, arg)
