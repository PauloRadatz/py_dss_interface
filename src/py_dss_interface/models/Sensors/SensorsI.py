...
class SensorsI(Base):
    ...
    def sensors_read_isdelta(self) -> int:
    ...
    def sensors_write_isdelta(self, argument) -> int:
    ...
    def sensors_read_reversedelta(self) -> int:
    ...
    def sensors_write_reversedelta(self, argument) -> int:
    ...
    def sensors_read_meteredterminal(self) -> int:
    ...
    def sensors_write_meteredterminal(self, argument) -> int:
