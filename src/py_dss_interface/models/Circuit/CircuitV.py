...
class CircuitV(Base):
    ...
    def circuit_line_losses(self) -> List[float]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 1, None, '')
    ...
    def circuit_substation_losses(self) -> List[float]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 2, None, '')
    ...
    def circuit_total_power(self) -> List[float]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 3, None, '')
    ...
    def circuit_all_bus_volts(self) -> List[float]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 4, None, '')
    ...
    def circuit_all_bus_vmag(self) -> List[float]:
        ...
        must be 0. """
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 5, None, '')
    ...
    def circuit_all_element_names(self) -> List[str]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 6, None, '')
    ...
    def circuit_all_bus_names(self) -> List[str]:
        ...
        Argument2 must be 0."""
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 7, None, '')
    ...
    def circuit_all_element_losses(self) -> List[float]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 8, None, '')
    ...
    def circuit_all_bus_vmag_pu(self) -> List[float]:
        ...
        Argument2 must be 0."""
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 9, None, '')
    ...
    def circuit_all_node_names(self) -> List[str]:
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 10, None, '')
    ...
    def circuit_system_y(self) -> List[float]:
        ...
        Argument2 must be 0."""
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 11, None, '')
    ...
    def circuit_all_bus_distances(self) -> List[float]:
        ...
        must be 0. """
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 12, None, '')
    ...
    def circuit_all_node_names_by_phase(self, argument=1) -> List[str]:
        ...
        argument = Base.check_int_param(argument, default=1)  # Phase 1 as default
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 17, argument, '')
    ...
    def circuit_y_node_varray(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 18, None, '')
    ...
    def circuit_y_node_order(self) -> List[str]:
        ...
        Argument2 must be 0."""
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 19, None, '')
    ...
    def circuit_y_currents(self):
        ...
        return Bridge.VarArrayFunction(self.dss_obj.CircuitV, 20, None, '')
