...
class CircuitV(Base):
    ...
    def all_node_vmag_by_phase(self, argument):
    ...
    def all_node_vmag_pu_by_phase(self, argument):
    ...
    def all_node_distances_by_phase(self, argument):
    ...
    def all_node_names_by_phase(self, argument):
