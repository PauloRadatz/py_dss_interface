...
class CircuitI(Base):
    ...
    def circuit_next_pc_element(self):
    ...
    def circuit_first_pd_element(self):
    ...
    def circuit_next_pd_element(self):
    ...
    def circuit_parent_pd_element(self):
    ...
    def circuit_end_of_time_step_update(self):
