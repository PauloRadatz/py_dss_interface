...
class ActiveClassI(Base):
    ...
    This interface returns an integer (signed 32 bits), the firts parameter is used to specify the
    property of the class to be used and the second variable can be used to modify the value of the property when
