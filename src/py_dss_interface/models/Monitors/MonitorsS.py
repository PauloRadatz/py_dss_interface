...
class MonitorsS(Base):
    ...
    def _file_name(self) -> str:
        result = ctypes.c_char_p(self._dss_obj.MonitorsS(ctypes.c_int32(0), "".encode('ascii')))
        return result.value.decode('ascii')

    def _name_read(self) -> str:
        result = ctypes.c_char_p(self._dss_obj.MonitorsS(ctypes.c_int32(1), "".encode('ascii')))
        return result.value.decode('ascii')
    ...
    def _element_read(self) -> str:
        result = ctypes.c_char_p(self._dss_obj.MonitorsS(ctypes.c_int32(3), "".encode('ascii')))
        return result.value.decode('ascii')
