...
class ParallelI(Base):
    ...
    def parallel_numcores(self) -> int:
    ...
    def parallel_createactor(self) -> int:
    ...
    def parallel_read_actorcpu(self) -> int:
    ...
    def parallel_read_activeparallel(self) -> int:
    ...
    def parallel_write_activeparallel(self, argument) -> int:
    ...
    def parallel_read_concatenatereportsl(self) -> int:
    ...
    def parallel_write_concatenatereportsl(self, argument) -> int:
