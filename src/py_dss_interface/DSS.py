...
from py_dss_interface import Circuit, DSSInterface, Loads, LoadShapes, Solution, Text, Topology, Transformers, XYCurves
...
class DSS:
    ...
    def __init__(self, dll_folder_param=None, dll_name=DLL_NAME):
        ...
        self.dll_path = System.get_architecture_dll(self.dll_folder)
